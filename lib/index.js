(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["simple-proxy-store-react"] = factory();
	else
		root["simple-proxy-store-react"] = factory();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  (function (global, factory) {
    ...
    exports.createProvider = exports.Connect = exports.connect = undefined;
    ...
    var Consumer = function Consumer(_ref) {
      ...
      var SubscribeCmp = function (_Component) {
        _inherits(SubscribeCmp, _Component);

        function SubscribeCmp() {
          _classCallCheck(this, SubscribeCmp);

          return _possibleConstructorReturn(this, (SubscribeCmp.__proto__ || Object.getPrototypeOf(SubscribeCmp)).apply(this, arguments));
        }

        _createClass(SubscribeCmp, [{
          ...
          value: function componentDidMount() {
            ...
            this.subscription = subscribe(select)(function (lastChange) {
              return _this2.setState({ lastChange: lastChange });
            });
          }
        }, {
          key: 'render',
          value: function render() {
            ...
            var preparedStore = storeKeys.reduce(function (acc, key) {
              var newVal = select.indexOf(key) > -1 ? store[key] : {};

              return _extends({}, acc, _defineProperty({}, key, newVal));
            }, {});
      ...
      return _react2.default.createElement(
        ...
        function (data) {
          ...
          return _react2.default.createElement(
            SubscribeCmp,
            { subscribe: subscribe, store: store },
            children
          );
        }
      );
        ...
        return function () {
          ...
          return _react2.default.createElement(
            ...
            function (_ref2) {
              ...
              return _react2.default.createElement(Cmp, _extends({}, props, store));
            }
          );
        };
      };
    ...
    var Connect = exports.Connect = function Connect(_ref3) {
    ...
    var createProvider = exports.createProvider = function createProvider(store) {
      var StoreProvider = function (_Component2) {
        _inherits(StoreProvider, _Component2);
